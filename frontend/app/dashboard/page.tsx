        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm text-gray-600 dark:text-gray-400">문서 수</p>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm text-gray-600 dark:text-gray-400">포럼 게시글</p>
                <p className="text-2xl font-semibold text-gray-900 dark:text-white">789</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm text-gray-600 dark:text-gray-400">블로그 포스트</p>
          ...
          <div className="p-6">
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-sm text-gray-900 dark:text-white">새로운 사용자가 가입했습니다</p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-sm text-gray-900 dark:text-white">새로운 문서가 생성되었습니다</p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-sm text-gray-900 dark:text-white">블로그 포스트가 업데이트되었습니다</p>
          ...
          <div className="p-6">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm text-gray-900 dark:text-white">127ms</span>
              </div>
            </div>
          </div>
        </div>
