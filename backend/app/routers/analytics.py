...
async def get_general_analytics():
    ...
    return {
        ...
        "popular_pages": [
            ...
            {"path": "/blog/react-18-features", "views": 2567, "title": "React 18 새로운 기능"},
...
async def get_content_analytics():
    ...
    return {
        "documents": {
            ...
            "monthly_new": 12,
            "most_viewed": [
                {"title": "시작 가이드", "path": "/docs/getting-started", "views": 3245, "rating": 4.8},
                {"title": "API 레퍼런스", "path": "/docs/api-reference", "views": 2891, "rating": 4.6},
                {"title": "설치 가이드", "path": "/docs/installation", "views": 2234, "rating": 4.7},
                {"title": "고급 기능", "path": "/docs/advanced", "views": 1987, "rating": 4.5},
                {"title": "문제 해결", "path": "/docs/troubleshooting", "views": 1756, "rating": 4.4}
            ],
            "categories": {
                "getting-started": 25,
                "api": 45,
        ...
        "blog": {
            ...
            "monthly_new": 15,
            "most_viewed": [
                {"title": "React 18의 새로운 기능들", "slug": "react-18-features", "views": 3245, "comments": 45},
                {"title": "Next.js 14 마이그레이션 가이드", "slug": "nextjs-14-migration", "views": 2891, "comments": 32},
                {"title": "TypeScript 베스트 프랙티스", "slug": "typescript-best-practices", "views": 2567, "comments": 28},
                {"title": "웹 성능 최적화 방법", "slug": "web-performance", "views": 2234, "comments": 41},
                {"title": "RESTful API 설계 원칙", "slug": "restful-api-design", "views": 1987, "comments": 36}
            ],
            "categories": {
                "frontend": 45,
                "backend": 38,
        ...
        "forum": {
            ...
            "most_active": [
                {"title": "React Hook 사용법 질문", "id": "1", "replies": 24, "views": 567},
