...
async def openid_configuration(request: Request):
    ...
    return {
        ...
        "claims_supported": [
            ...
            "preferred_username", "email", "email_verified", "picture"
        ],
...
async def handle_authorization_code_grant(
    ...
    if auth_data.get("code_challenge"):
        if not code_verifier:
            ...
            print(f"Warning: PKCE challenge present but no verifier provided. Skipping PKCE validation for development.")
        else:
            # S256 방식 검증
